	...
	{#if !fullscreenMode}
		<div class="controls-info">
			<p class="text-sm text-gray-400 keyboard-shortcuts">
				Controls: Ctrl/Cmd+O to open file | Mouse wheel to zoom | Middle mouse or Space+Drag to pan | Arrow keys to move | Enter to zoom in | Shift+Enter to zoom out | F (tap) fit view, (hold) fullscreen | Esc to exit fullscreen | G to toggle grid | O to toggle fill/outline | P to toggle info panel | L to toggle layer panel | M to toggle minimap | Touch: One finger to pan, two fingers to zoom
			</p>
